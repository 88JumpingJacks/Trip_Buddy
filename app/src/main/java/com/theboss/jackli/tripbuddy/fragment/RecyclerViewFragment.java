package com.theboss.jackli.tripbuddy.fragment;
...
import com.theboss.jackli.tripbuddy.TestRecyclerViewAdapter;
...
public class RecyclerViewFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new RecyclerViewMaterialAdapter(new TestRecyclerViewAdapter(mContentItems, getActivity(), category));
